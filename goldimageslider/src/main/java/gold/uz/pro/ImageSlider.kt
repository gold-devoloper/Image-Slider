...
import gold.uz.pro.adapters.ViewPagerAdapter
...
class ImageSlider @JvmOverloads constructor(
    ...
    init {
        ...
        cornerRadius = typedArray.getInt(R.styleable.ImageSlider_gold_corner_radius, 1)
        period = typedArray.getInt(R.styleable.ImageSlider_gold_period, 1000).toLong()
        delay = typedArray.getInt(R.styleable.ImageSlider_gold_delay, 1000).toLong()
        autoCycle = typedArray.getBoolean(R.styleable.ImageSlider_gold_auto_cycle, false)
        placeholder = typedArray.getResourceId(
            R.styleable.ImageSlider_gold_placeholder,
            R.drawable.loading
        )
        errorImage = typedArray.getResourceId(
            R.styleable.ImageSlider_gold_error_image,
            R.drawable.error
        )
        selectedDot = typedArray.getResourceId(
            R.styleable.ImageSlider_gold_selected_dot,
            R.drawable.default_selected_dot
        )
        unselectedDot = typedArray.getResourceId(
            R.styleable.ImageSlider_gold_unselected_dot,
            R.drawable.default_unselected_dot
        )
        titleBackground = typedArray.getResourceId(
            R.styleable.ImageSlider_gold_title_background,
            R.drawable.gradient
        )

        if (typedArray.getString(R.styleable.ImageSlider_gold_text_align) != null){
            textAlign = typedArray.getString(R.styleable.ImageSlider_gold_text_align)!!
        }

        if (typedArray.getString(R.styleable.ImageSlider_gold_indicator_align) != null){
            indicatorAlign = typedArray.getString(R.styleable.ImageSlider_gold_indicator_align)!!
        }
